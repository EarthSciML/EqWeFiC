...
| SW radiation (Dudhia) | clear-sky absorption/scattering, cloud albedo/absorption, column integrals | `phys/module_ra_sw.F` | — | instrumented (SCM dumps + SWPARA column internals; real64/real32 drivers; 2026-09-05) |
