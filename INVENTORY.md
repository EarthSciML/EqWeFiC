...
| Microphysics (WSM6) | saturation adjustment; warm rain (praut, pracw, prevp); ice processes; melting/freezing; sedimentation | `phys/physics_mmm/mp_wsm6.F90` | — | instrumented (SCM + supercell dumps incl. all process rates raw/final and the rate-evaluation state; real64/real32 drivers; 2026-09-05) |
